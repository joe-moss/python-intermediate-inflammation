...
class JSONDataSource:
    '''Loads patient data with inflammation values from JSOn files within a specified directory'''
    def __init__(self, data_dir):
        self.data_dir = data_dir

    def load_inflammation_data(self):
        '''Loads inflammation data from JSON files within a specified directory'''
...
data_source1 = CSVDataSource(os.path.dirname('data/inflammation.csv'))
analyse_data(data_source1)
